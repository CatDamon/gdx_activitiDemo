...
public class ActivitiDemo5 {
	...
	public void deploymentProcessDefinition_inputStream(){  
	    ...
	    Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Service  
	                    ...
	                    .name("连线")//添加部署的名称  
	                    .addInputStream("LeaveOfProcess3.bpmn", inputStreamBpmn)//  
	                    .addInputStream("LeaveOfProcess3.png", inputStreamPng)//  
	                    .deploy();//完成部署  
	    System.out.println("部署ID："+deployment.getId());//  部署ID：47501
	    System.out.println("部署名称："+deployment.getName());//  部署名称：连线
	} 
	...
	public void startProcessInstance(){  
	    ...
	    System.out.println("流程定义ID:"+pi.getProcessDefinitionId());//流程定义ID:leaveOfProcess3:1:47504
	}
	
    /**查询当前人的个人任务
     * 任务ID:50004
		任务名称:部门经理审核
		任务的创建时间:Wed Apr 26 15:02:46 CST 2017
		任务的办理人:部门经理
		流程实例ID：50001
		执行对象ID:50001
		流程定义ID:leaveOfProcess3:1:47504
		########################################################
     * 
     * */  
    @Test  
